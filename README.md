...
It's a universal [counter script](php/count.php). ... v**5.1.0**!
...
> **Note**
> I'd suggest you to also copy the **[`count.sh`](sh/count.sh)** (wrapper) shell/bash script to easily execute the script
...
due to the header..). **Now** I've added a script **[count.sh`](sh/count.sh)**, which will wrap this for you,
...
> **Note**
> As of v**5.1.0** there are 'only' **_10.378_ code lines** left (and there are nearly no comments).
