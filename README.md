...
It's a universal counter script. ... v**3.6.8**!
...
- [x] Nice improvement for my [`delete()` function](#deletion): **floating point results** // ..and **fixed** counted values (v**3.6.8**)!
...
> **Note**
> After cleaning up a bit, removing comments, etc. there are **_7.009_ code lines** left,
> as of v**3.6.8**!
